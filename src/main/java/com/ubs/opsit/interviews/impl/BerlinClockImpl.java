...
public class BerlinClockImpl implements TimeConverter {
	...
	public String convertTime(String aTime) {
		...
		int mins = Integer.parseInt(inputData[1]);
		int seconds = Integer.parseInt(inputData[2]);

		if (validateInputTime(hours, mins, seconds)) {
			...
			System.out.println("Please enter correct time as input : hh:mm:ss"); // Can be configured in logs using log4J																					
			return null;
		}
	}
	 ...
	 * { 
	 * 		BerlinClock time = new BerlinClock();
